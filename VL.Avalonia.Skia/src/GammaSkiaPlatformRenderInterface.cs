...
namespace VL.Avalonia.Skia
{
    public class GammaSkiaPlatformRenderInterface : IPlatformRenderInterface
    {
        ...
        public IGlyphRunImpl CreateGlyphRun(
            ...
            _platformRenderInterface.CreateGlyphRun(
                glyphTypeface,
                fontRenderingEmSize,
                glyphInfos,
                baselineOrigin
        ...
        public IBitmapImpl LoadBitmap(Stream stream) => _platformRenderInterface.LoadBitmap(stream);
