...
namespace VL.Avalonia.Controls
{
    ...
    /// </summary>
    [ProcessNode]
    public partial class DecoratorBaseWrapper<T> : ControlWrapperBase<T> where T : Decorator, new()
    {
        ...
        [ImplementProperty("Decorator.PaddingProperty", PinVisibility = Model.PinVisibility.Optional)]
