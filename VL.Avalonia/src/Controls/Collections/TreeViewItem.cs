...
public partial class TreeViewItemSpectralAdvancedWrapper<T> : HeaderedItemsControlWrapperBase<TreeViewItem, T>
{
    ...
    {
        _isExpandedBinding = new ChannelTwoWayBinding<bool>(_output, TreeViewItem.IsExpandedProperty);
        _isSelectedBinding = new ChannelTwoWayBinding<bool>(_output, TreeViewItem.IsSelectedProperty);
    }

    /// <param name="isExpandedChannel"> 
    /// Whether this list item is currently expanded
    /// </param>
    public void SetIsExpandedChannel([Pin(Visibility = Model.PinVisibility.Optional)] IChannel<bool> isExpandedChannel) =>
