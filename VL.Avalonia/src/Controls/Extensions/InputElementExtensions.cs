...
public static partial class Extensions
{
    ...
    public static bool Focusable(InputElement? input) => input?.IsEnabled ?? false;

    /// <inheritdoc cref="InputElement.IsEnabled" />
    public static bool IsEnabled(InputElement? input) => input?.IsEnabled ?? false;

    /// <inheritdoc cref="InputElement.Cursor" />
    public static Cursor? Cursor(InputElement? input) => input?.Cursor;
    ...
    public static bool IsFocused(InputElement? input) => input?.IsFocused ?? false;

    /// <inheritdoc cref="InputElement.IsPointerOver" />
    public static bool IsPointerOver(InputElement? input) => input?.IsPointerOver ?? false;
}
