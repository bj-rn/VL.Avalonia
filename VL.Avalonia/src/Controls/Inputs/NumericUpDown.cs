    ...
    where T : NumericUpDown, new()
{
    ...
    /// </param>
    [ImplementProperty(
        "NumericUpDown.ClipValueToMinMaxProperty",
        PinVisibility = Model.PinVisibility.Optional
    )]
    ...
    /// </param>
    [ImplementProperty(
        "NumericUpDown.AllowSpinProperty",
        PinVisibility = Model.PinVisibility.Optional
    )]
    ...
    /// </param>
    [ImplementProperty(
        "NumericUpDown.ShowButtonSpinnerProperty",
        PinVisibility = Model.PinVisibility.Optional
    )]
    ...
    /// </param>
    [ImplementProperty(
        "NumericUpDown.FormatStringProperty",
        PinVisibility = Model.PinVisibility.Optional
    )]
    ...
    /// </param>
    [ImplementProperty(
        "NumericUpDown.NumberFormatProperty",
        PinVisibility = Model.PinVisibility.Optional
    )]
    ...
    /// </param>
    [ImplementProperty(
        "NumericUpDown.ParsingNumberStyleProperty",
        PinVisibility = Model.PinVisibility.Optional
    )]
    ...
    /// </param>
    [ImplementProperty(
        "NumericUpDown.TextConverterProperty",
        PinVisibility = Model.PinVisibility.Optional
    )]
    ...
    /// </param>
    [ImplementProperty(
        "NumericUpDown.HorizontalContentAlignmentProperty",
        PinVisibility = Model.PinVisibility.Optional
    )]
    ...
    /// </param>
    [ImplementProperty(
        "NumericUpDown.VerticalContentAlignmentProperty",
        PinVisibility = Model.PinVisibility.Optional
    )]
    ...
    /// </param>
    [ImplementProperty(
        "NumericUpDown.InnerLeftContentProperty",
        PinVisibility = Model.PinVisibility.Optional
    )]
    ...
    /// </param>
    [ImplementProperty(
        "NumericUpDown.InnerRightContentProperty",
        PinVisibility = Model.PinVisibility.Optional
    )]
