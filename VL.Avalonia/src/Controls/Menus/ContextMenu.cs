...
public partial class ContextMenuSpectralWrapper : MenuBaseWrapper<ContextMenu, object?>
{
    ...
    /// </param>
    [ImplementProperty(
        "ContextMenu.PlacementAnchorProperty",
        PinVisibility = Model.PinVisibility.Optional
    )]
    ...
    /// </param>
    [ImplementProperty(
        "ContextMenu.PlacementConstraintAdjustmentProperty",
        PinVisibility = Model.PinVisibility.Optional
    )]
    ...
    /// </param>
    [ImplementProperty(
        "ContextMenu.PlacementGravityProperty",
        PinVisibility = Model.PinVisibility.Optional
    )]
    ...
    /// </param>
    [ImplementProperty(
        "ContextMenu.PlacementRectProperty",
        PinVisibility = Model.PinVisibility.Optional
    )]
    ...
    /// </param>
    [ImplementProperty(
        "ContextMenu.WindowManagerAddShadowHintProperty",
        PinVisibility = Model.PinVisibility.Optional
    )]
    ...
    /// </param>
    [ImplementProperty(
        "ContextMenu.CustomPopupPlacementCallbackProperty",
        PinVisibility = Model.PinVisibility.Optional
    )]
