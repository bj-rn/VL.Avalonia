...
namespace VL.Avalonia.Styles
{
    ...
    {
        public SetRenderTransformMatrix()
            : base("RenderTransform", (x) => x.ToAvaloniaMatrix()) { }
    }
    ...
    {
        public SetRenderTransformAnimatable()
            : base(
                "RenderTransform",
                (x) =>
                {
    ...
    {
        public SetRenderTransformOrigin()
    ...
    {
        public SetCornerRadiusAll()
            : base("CornerRadius", (x) => new CornerRadius(x)) { }
    }

    [ProcessNode(Name = "SetCornerRadius")]
    public class SetCornerRadiusHV : StyleSetterCornerRadiusTB
    {
        public SetCornerRadiusHV()
            : base("CornerRadius") { }
    }
    ...
    {
        public SetHorizontalContentAlignment()
    ...
    {
        public SetVerticalContentAlignment()
    ...
    {
        public SetItemContainerTheme()
            : base("ItemContainerTheme") { }
    }
    ...
    */
    ...
    {
        public SetAutoScrollToSelectedItem()
            : base("AutoScrollToSelectedItem") { }
    }
    ...
    {
        public SetWindowManagerAddShadowHint()
            : base("WindowManagerAddShadowHint") { }
    }
    ...
    {
        public SetInheritsTransform()
            : base("InheritsTransform") { }
    }
    ...
    {
        public SetPlacementAnchor()
            : base("PlacementAnchor") { }
    }
    ...
    {
        public SetPlacementConstraintAdjustment()
            : base("PlacementConstraintAdjustment") { }
    }

    [ProcessNode(Name = "SetPlacementGravity")]
    public class SetPlacementGravity : StyleSetter<PopupGravity>
    {
        public SetPlacementGravity()
            : base("PlacementGravity") { }
    }
    ...
    {
        public SetCustomPopupPlacementCallback()
            : base("CustomPopupPlacementCallback") { }
    }

    [ProcessNode(Name = "SetOverlayDismissEventPassThrough")]
    public class SetOverlayDismissEventPassThrough : StyleSetter<bool>
    {
        public SetOverlayDismissEventPassThrough()
            : base("OverlayDismissEventPassThrough") { }
    }
    ...
    {
        public SetOverlayInputPassThroughElement()
            : base("OverlayInputPassThroughElement") { }
    }
    ...
    {
        public SetHorizontalOffset()
            : base("HorizontalOffset", (x) => (double)x) { }
    }

    [ProcessNode(Name = "SetIsLightDismissEnabled")]
    public class SetIsLightDismissEnabled : StyleSetter<bool>
    {
        public SetIsLightDismissEnabled()
            : base("IsLightDismissEnabled") { }
    }
    ...
    {
        public SetVerticalOffset()
            : base("VerticalOffset", (x) => (double)x) { }
    }
    ...
    {
        public SetShouldUseOverlayLayer()
            : base("ShouldUseOverlayLayer") { }
    }
    ...
    {
        public SetStretchDirection()
            : base("StretchDirection") { }
    }
    ...
    {
        public SetData()
            : base("Data", (data) => Geometry.Parse(data)) { }
    }
    ...
    {
        public SetHidePromptOnLeave()
            : base("HidePromptOnLeave") { }
    }
    ...
    {
        public SetOffContentTemplate()
            : base("OffContentTemplate") { }
    }
    ...
    {
        public SetOnContentTemplate()
            : base("OnContentTemplate") { }
    }

    [ProcessNode(Name = "SetKnobTransitions")]
    public class SetKnobTransitions : StyleSetterTransitions
    {
        public SetKnobTransitions()
            : base("KnobTransitions") { }
    }
    ...
    {
        public SetMaxDropDownHeight()
            : base("MaxDropDownHeight", (x) => (double)x) { }
    }
    ...
    {
        public SetPlaceholderForeground()
            : base("PlaceholderForeground") { }
    }

    [ProcessNode(Name = "SetPlaceholderForeground")]
    public class SetPlaceholderForegroundColor : StyleSetterBrushColor
    {
        public SetPlaceholderForegroundColor()
            : base("PlaceholderForeground") { }
    }
    ...
    {
        public SetSelectionBoxItemTemplate()
            : base("SelectionBoxItemTemplate") { }
    }
    ...
    {
        public SetItemSpacing()
            : base("ItemSpacing", (x) => (double)x) { }
    }
    ...
    */
    ...
    {
        public SetFlyoutPresenterTheme()
            : base("FlyoutPresenterTheme") { }
    }
    ...
    {
        public SetCanHorizontallyScroll()
            : base("CanHorizontallyScroll") { }
    }

    [ProcessNode(Name = "SetCanVerticallyScroll")]
    public class SetCanVerticallyScroll : StyleSetter<bool>
    {
        public SetCanVerticallyScroll()
            : base("CanVerticallyScroll") { }
    }
    ...
    */
    ...
    {
        public SetStartAngle()
            : base("StartAngle", (x) => (double)(x * 360.0f)) { }
    }

    [ProcessNode(Name = "SetSweepAngle")]
    public class SetSweepAngle : StyleSetter<float, double>
    {
        public SetSweepAngle()
            : base("SweepAngle", (x) => (double)(x * 360.0f)) { }
    }
    ...
    {
        public SetShowSelectionHighlight()
            : base("ShowSelectionHighlight") { }
    }

    [ProcessNode(Name = "SetCaretIndex")]
    public class SetCaretIndex : StyleSetter<int>
    {
        public SetCaretIndex()
            : base("CaretIndex") { }
    }
    ...
    {
        public SetSelectionForegroundBrush()
            : base("SelectionForegroundBrush") { }
    }

    [ProcessNode(Name = "SetSelectionForegroundBrush")]
    public class SetSelectionForegroundBrushColor : StyleSetterBrushColor
    {
        public SetSelectionForegroundBrushColor()
            : base("SelectionForegroundBrush") { }
    }
    ...
    {
        public SetCaretBlinkInterval()
            : base("CaretBlinkInterval") { }
    }
    ...
    {
        public SetPreeditTextCursorPosition()
            : base("PreeditTextCursorPosition") { }
    }
    ...
    {
        public SetHorizontalHeaderAlignment()
            : base("HorizontalHeaderAlignment") { }
    }

    [ProcessNode(Name = "SetVerticalHeaderAlignment")]
    public class SetVerticalHeaderAlignment : StyleSetter<VerticalAlignment>
    {
        public SetVerticalHeaderAlignment()
            : base("VerticalHeaderAlignment") { }
    }
    ...
    */
    ...
    {
        public SetCalendarTemplate()
            : base("CalendarTemplate") { }
    }
    ...
    {
        public SetWatermarkTemplate()
            : base("WatermarkTemplate") { }
    }
    ...
    {
        public SetRowSpacing()
            : base("RowSpacing", (x) => (double)x) { }
    }

    [ProcessNode(Name = "SetColumnSpacing")]
    public class SetColumnSpacing : StyleSetter<float, double>
    {
        public SetColumnSpacing()
            : base("ColumnSpacing", (x) => (double)x) { }
    }
    ...
    {
        public SetUseFloatingWatermark()
            : base("UseFloatingWatermark") { }
    }
    ...
    {
        public SetInnerLeftContent()
            : base("InnerLeftContent") { }
    }

    [ProcessNode(Name = "SetInnerRightContent")]
    public class SetInnerRightContent : StyleSetter<object>
    {
        public SetInnerRightContent()
            : base("InnerRightContent") { }
    }
    ...
    {
        public SetHorizontalSpacing()
            : base("HorizontalSpacing", (x) => (double)x) { }
    }

    [ProcessNode(Name = "SetVerticalSpacing")]
    public class SetVerticalSpacing : StyleSetter<float, double>
    {
        public SetVerticalSpacing()
            : base("VerticalSpacing", (x) => (double)x) { }
    }
    ...
    {
        public SetTabStripPlacement()
            : base("TabStripPlacement") { }
    }
    ...
    {
        public SetValidSpinDirection()
            : base("ValidSpinDirection") { }
    }
    ...
    {
        public SetIsTodayHighlighted()
            : base("IsTodayHighlighted") { }
    }
    ...
    {
        public SetSelectionModeCalendar()
            : base("SelectionMode") { }
    }
    ...
    {
        public SetAllowTapRangeSelection()
            : base("AllowTapRangeSelection") { }
    }
    ...
    {
        public SetHeaderBackgroundColor()
            : base("HeaderBackground") { }
    }
    ...
    {
        public SetDayTitleTemplate()
            : base("DayTitleTemplate") { }
    }
    ...
    {
        public SetIsTransitionReversed()
            : base("IsTransitionReversed") { }
    }
    ...
    {
        public SetBaselineAlignment()
            : base("BaselineAlignment") { }
    }
    ...
    {
        public SetTextSelector()
            : base("TextSelector") { }
    }

    [ProcessNode(Name = "SetAsyncPopulator")]
    public class SetAsyncPopulator
        : StyleSetter<Func<string, CancellationToken, Task<IEnumerable<object>>>>
    {
        public SetAsyncPopulator()
            : base("AsyncPopulator") { }
    }
    ...
    {
        public SetIsTextCompletionEnabled()
            : base("IsTextCompletionEnabled") { }
    }
