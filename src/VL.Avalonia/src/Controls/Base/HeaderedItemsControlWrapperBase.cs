...
/// </summary>
[ProcessNode]
public abstract partial class HeaderedItemsControlWrapperBase<TControl, TValue> : ItemsControlWrapperBase<TControl, TValue> where TControl : HeaderedItemsControl, new()
{
