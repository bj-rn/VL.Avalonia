...
public partial class TimePickerWrapper : ControlWrapperBase<TimePicker>
{
    ...
    {
        _selectedTimeBinding = new ChannelTwoWayBinding<TimeSpan?>(_output, TimePicker.SelectedTimeProperty);
    }
    ...
    /// </param>
    [ImplementProperty("TimePicker.MinuteIncrementProperty", PinVisibility = Model.PinVisibility.Optional)]
    private Optional<int> _minuteIncrement;

    /// <param name="secondIncrement">
    /// Sets the second increment in the picker
    /// </param>
    [ImplementProperty("TimePicker.SecondIncrementProperty", PinVisibility = Model.PinVisibility.Optional)]
    ...
    /// </param>
    [ImplementProperty("TimePicker.ClockIdentifierProperty", PinVisibility = Model.PinVisibility.Optional)]
    private Optional<string> _clockIdentifier;

    /// <param name="useSeconds">
    /// Sets the use seconds switch, either true or false
    /// </param>
    [ImplementProperty("TimePicker.UseSecondsProperty", PinVisibility = Model.PinVisibility.Optional)]
